...
path_fooocus_expansion = get_dir_or_set_default('path_fooocus_expansion', '../models/prompt_expansion/ai_image_generator_expansion')
...
default_temp_path = os.path.join(tempfile.gettempdir(), 'ai_image_generator')
...
default_metadata_scheme = get_config_item_or_set_default(
    ...
    default_value=MetadataScheme.AI_IMAGE_GENERATOR.value,
...
def get_model_filenames(folder_paths, extensions=None, name_filter=None):
    if extensions is None:
        extensions = ['.pth', '.ckpt', '.bin', '.safetensors', '.ai_image_generator.patch']
    files = []
