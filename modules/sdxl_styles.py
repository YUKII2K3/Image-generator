...
for x in ['sdxl_styles_ai_image_generator.json',
...
ai_image_generator_expansion = 'AI Image Generator V2'
random_style_name = 'Random Style'
legal_style_names = [ai_image_generator_expansion, random_style_name] + style_keys
