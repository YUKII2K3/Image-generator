    ...
    while not finished:
        ...
        if len(task.yields) > 0:
            ...
            if flag == 'finish':
                ...
                # delete AI Image Generator temp images, only keep gradio temp images
...
title = f'AI Image Generator {image_generator_version.version}'
    ...
    with gr.Row():
            ...
            with gr.Row(visible=modules.config.default_image_prompt_checkbox) as image_input_panel:
                with gr.Tabs(selected=modules.config.default_selected_image_input_tab_id):
                    with gr.Tab(label='Upscale or Variation', id='uov_tab') as uov_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="#" target="_blank">\U0001F4D4 Documentation</a>')
                    ...
                    with gr.Tab(label='Metadata', id='metadata_tab') as metadata_tab:
                        with gr.Column():
                            metadata_input_image = grh.Image(label='For images created by AI Image Generator', source='upload', type='pil')
                        ...
                        with gr.Tab(label=f'#{index + 1}') as enhance_tab_item:
                            ...
                            with gr.Accordion("Inpaint", visible=True, open=False):
                                ...
                                enhance_inpaint_engine = gr.Dropdown(label='Inpaint Engine',
                                                                     ...
                                                                     info='Version of AI Image Generator inpaint model. If set, use performance Quality or Speed (no performance LoRAs) for best results.')
                ...
                with gr.Column(visible=modules.config.default_developer_debug_mode_checkbox) as dev_tools:
                    with gr.Tab(label='Debug Tools'):
                        ...
                        adaptive_cfg = gr.Slider(label='CFG Mimicking from TSNR', minimum=1.0, maximum=30.0, step=0.01,
                                                 ...
                                                 info='Enabling AI Image Generator\'s implementation of CFG mimicking for TSNR '
        ...
        def trigger_describe(modes, img, apply_styles):
            ...
            if flags.describe_type_photo in modes:
                ...
                styles.update(["AI Image Generator V2", "AI Image Generator Enhance", "AI Image Generator Sharp"])

            if flags.describe_type_anime in modes:
                from extras.wd14tagger import default_interrogator as default_interrogator_anime
                describe_prompts.append(default_interrogator_anime(img))
                styles.update(["AI Image Generator V2", "AI Image Generator Masterpiece"])
